...
namespace WindowsFormsApp1
{
    public partial class seller : Form
    {
        ...
        private void cHANGEPASSWORDORUSERNAMEToolStripMenuItem_Click(object sender, EventArgs e)
        {
            sellerchange s = new sellerchange();
            s.Show();
        }

        private void bILLSToolStripMenuItem_Click(object sender, EventArgs e)
        {
            bill_seller s = new bill_seller();
            s.Show();
        }
    }
}
